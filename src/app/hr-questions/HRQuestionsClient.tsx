...
const HRQuestionsClient: React.FC = () => {
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 pb-16 sm:px-6 sm:pb-20">
      ...
      >
        <div className="mt-4 w-full max-w-xl">
          <input
            ...
            inputMode="search"
            className="w-full rounded-full border border-[#9a3412]/12 bg-[#f0e7d6]/55 px-5 py-3 text-sm shadow-sm outline-none transition-colors focus:border-[#f97316] dark:border-white/10 dark:bg-[#f97316]/8 dark:text-white"
          />
          {normalizedQuery && (
                ...
                {cat.items.map((item, idx) => (
                  <div
                    ...
                    className={`scroll-mt-24 rounded-xl border p-5 shadow-sm sm:p-6 ${
                      isSelfIntro
                        ? 'border-[#ea580c]/35 bg-linear-to-br from-[#efe6d4] to-[#e7dbc3]/60 dark:border-white/12 dark:from-white/8 dark:to-white/4'
                        : 'border-[#9a3412]/12 bg-[#f0e7d6]/55 dark:border-white/10 dark:bg-[#f97316]/8'
                    }`}
                  >
      ...
      {!normalizedQuery && (
        <section className="mt-10 rounded-xl border border-[#ea580c]/25 bg-linear-to-br from-[#c2410c] via-[#ea580c] to-[#fb923c] p-5 text-white shadow-sm sm:p-7">
