...
const HRQuestionsClient: React.FC = () => {
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 pb-16 sm:px-6 sm:pb-20">
      ...
      >
        <div className="mt-4 w-full max-w-xl">
          <input
            ...
            inputMode="search"
            className="w-full rounded-full border border-orange-900/8 bg-orange-50/60 px-5 py-3 text-sm shadow-sm outline-none transition-colors focus:border-orange-500 dark:border-orange-400/10 dark:bg-orange-500/5 dark:text-white"
          />
          {normalizedQuery && (
                ...
                {cat.items.map((item, idx) => (
                  <div
                    ...
                    className={`rounded-xl border p-5 shadow-sm sm:p-6 ${
                      isSelfIntro
                        ? 'border-orange-500/30 bg-linear-to-br from-orange-50 to-amber-50/60 dark:border-orange-400/20 dark:from-orange-500/10 dark:to-amber-500/5'
                        : 'border-orange-900/8 bg-orange-50/60 dark:border-orange-400/10 dark:bg-orange-500/5'
                    }`}
                  >
      ...
      {!normalizedQuery && (
        <section className="mt-10 rounded-xl border border-orange-500/20 bg-linear-to-br from-orange-600 via-amber-500 to-yellow-500 p-5 text-white shadow-sm sm:p-7">
