    ...
    <header className="sticky top-0 z-50 border-b border-black/5 bg-white/80 backdrop-blur-md dark:border-white/10 dark:bg-black/50">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 sm:gap-4 sm:px-6 sm:py-4">
        <a href="/" className="flex min-w-0 items-center gap-2.5 sm:gap-3">
          <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-linear-to-br from-sky-600 via-cyan-500 to-emerald-400 font-mono text-xs font-bold text-white shadow-sm sm:h-9 sm:w-9 sm:text-sm">
            {'</>'}
          </span>
        ...
        <span className="hidden shrink-0 rounded-full bg-linear-to-r from-sky-600 via-cyan-500 to-emerald-400 px-3 py-1 text-xs font-semibold text-white shadow-sm sm:inline-block">
          26 Components
        </span>
      ...
      >
        <div className="min-h-0">
          <div className="flex flex-col gap-1 px-4 py-3">
            ...
            <span className="mt-1 w-fit rounded-full bg-linear-to-r from-sky-600 via-cyan-500 to-emerald-400 px-3 py-1 text-xs font-semibold text-white shadow-sm">
              26 Components
            </span>
          </div>
        </div>
