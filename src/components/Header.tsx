...
const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#9a3412]/12 bg-[#f4ecdd]/85 backdrop-blur-md dark:border-white/8 dark:bg-[#181511]/85">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 sm:gap-4 sm:px-6 sm:py-4">
        <a href="/" className="flex min-w-0 items-center gap-2.5 sm:gap-3">
          <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-linear-to-br from-[#c2410c] via-[#ea580c] to-[#fb923c] font-mono text-xs font-bold text-white shadow-sm sm:h-9 sm:w-9 sm:text-sm">
            {'</>'}
          </span>
        ...
        <nav className="hidden items-center gap-4 text-sm font-medium text-gray-600 lg:gap-6 sm:flex dark:text-gray-300">
          ...
          <a href="/roadmap-mobile" className="transition-colors hover:text-gray-900 dark:hover:text-white">
            Mobile
          </a>
        </nav>
        ...
        <a
          href="/components"
          className="hidden shrink-0 rounded-full bg-linear-to-r from-[#c2410c] via-[#ea580c] to-[#fb923c] px-3 py-1 text-xs font-semibold text-white shadow-sm transition-transform hover:scale-105 sm:inline-block"
        >
          26 Components
        </a>
        ...
        <div className="min-h-0">
          <div className="flex flex-col gap-1 px-4 py-3">
            ...
            <a
              href="/components"
              onClick={() => setMenuOpen(false)}
              className="mt-1 w-fit rounded-full bg-linear-to-r from-[#c2410c] via-[#ea580c] to-[#fb923c] px-3 py-1 text-xs font-semibold text-white shadow-sm"
            >
              26 Components
            </a>
          </div>
